          ...
          <div className="author col-md-4" onClick={navigateToAuthorProfile}>
            <div className="position-sticky my-5" style={{ top: "2rem" }}>
              <div className="p-4 mb-3 bg-light rounded">
                ...
                <img src={blog.author.image || "https://storage.googleapis.com/ix-blog-app/download.png"} className="avatar" alt="..." />
                <p>{blog.author.bio ? blog.author.bio.substring(0, 100) + "..." : "No bio available"}</p>
              </div>
            </div>
          </div>
        </div>
